...
The details on the underlying algorithm are described in the following paper:
...
**Note**: Hecate relies on S-Taliro for its set of search algorithms. Make sure to read the Installation instructions and download S-Taliro.
...
4. Run the function `updateStaliro` by providing the name of the folder containing S-Taliro.  
