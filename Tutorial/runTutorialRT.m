%% Tutorial on the use of Hecate with Requirements Table on an Automotive model.
...
% transmission reading the specification from a Requirements Table block.
...
% Warning for unused symbols in the Test Sequence/Requirements Table.
...
hecateOpt.spec_source = "requirements table";
...
% requirement specification. Since we are reading the requirements from a
% Requirements Table, this field can be left empty.
...
fileStr = "./HecateTutorialRT_" + fileStr + ".mat";
